...
config_dict = {
    "run_name" : "DDPM-LSUN-TEST_v1_nodp",
    "num_train_timestamps" : 1000,
    "num_inference_steps" : 1000,
    "dataset" : "LSUN_CHURCH", # "CIFAR10" / "FFHQ" / "LSUN_CHURCH"
    ...
    "output_dir" : 'ddpm-lsun_nodp',  # the model namy locally and on the HF Hub
...
# Start Training
utils.ddpm_train_loop(config, model, noise_scheduler, optimizer, train_loader, lr_scheduler)
